...
- Manual quickstart (file sequence): `.issues/GLM-N/issue.md` → `.issues/GLM-N/plan.md` → `.issues/GLM-N/summary-1.md` (after work) → `.issues/GLM-N/summary.md` (when done) → update `.issues/index.md`.

...
- `.issues/GLM-1/plan.md` - noted rate-limit strategy.
- `.issues/GLM-1/summary-23.md` - session summary.

## Verification
- N/A (planning update only).

## Next Steps
- Implement a throttled fetch helper and apply it to GitLab API calls.

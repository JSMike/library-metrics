...
- `.issues/GLM-1/plan.md` - updated goals and data model scope.
- `.issues/GLM-1/summary-6.md` - session summary.

## Verification
- N/A (planning updates only).

## Next Steps
- Produce the concrete schema proposal and decide table names/fields for implementation.

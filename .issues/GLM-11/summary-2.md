...
## Completed
- Re-scoped GLM-11 to cover the Bun migrator change.
...
## Current Status
- GLM-11 is in progress; changes are ready for verification.
...
- `.issues/GLM-11/issue.md` - re-scoped GLM-11.
- `.issues/GLM-11/plan.md` - updated plan.
- `.issues/index.md` - moved GLM-11 back to in-progress.

...
**Prompt/Ask:** Start implementing and move GLM-2 to in-progress.

## Completed
- Moved GLM-2 to in-progress and updated the issue index.
...
## Files Changed
- `.issues/GLM-2/issue.md` - set status to in-progress.
- `.issues/index.md` - moved GLM-2 to in-progress.

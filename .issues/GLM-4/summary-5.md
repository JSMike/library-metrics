...
**Prompt/Ask:** Continue GLM-4 implementation for usage queries (targets list, drilldowns, per-file detail) with URL-driven pagination/filtering.
...
## Current Status
- GLM-4 implementation is mostly in place; needs local verification and a sync run after migrating to populate file-level usage data.

...
## Current Status
- GLM-5 is in progress; implementation complete pending verification.
...
- `.issues/GLM-5/issue.md` - status set to in-progress.
- `.issues/index.md` - moved GLM-5 to In Progress.

...
## Completed
- Updated GLM-8 requirements to include retry logic for file/search timeouts and note file/search as primary bottlenecks.
- Updated the plan to include retry policy and backoff configuration.

## Current Status
- GLM-8 remains in backlog awaiting implementation details.

## Plan Coverage
- Refinement of requirements and approach.

## Files Changed
- `.issues/GLM-8/issue.md` - added retry requirement and clarified bottlenecks.
- `.issues/GLM-8/plan.md` - added retry policy steps.

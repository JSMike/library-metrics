...
- Documented lockfile selection rules in LM-1.
...
- `.issues/LM-1/issue.md` - updated lockfile rules.
- `.issues/LM-1/plan.md` - updated lockfile selection guidance.
- `.issues/LM-1/summary-33.md` - session summary.

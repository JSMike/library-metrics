...
- `.issues/LM-1/issue.md` - noted reporting helper requirement.
- `.issues/LM-1/plan.md` - updated plan with reporting helpers.
- `.issues/LM-1/summary-37.md` - session summary.

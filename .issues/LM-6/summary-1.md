...
## Current Status
- LM-6 is in progress; change is complete pending verification.
...
- `.issues/LM-6/issue.md` - new issue.
- `.issues/LM-6/plan.md` - draft plan.
- `.issues/index.md` - added LM-6 to In Progress.

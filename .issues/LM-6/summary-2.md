...
- Expanded LM-6 scope to include /dependencies.

## Current Status
- LM-6 is in progress; changes are complete pending verification.
...
- `.issues/LM-6/issue.md` - updated scope to include /dependencies.
- `.issues/LM-6/plan.md` - updated plan wording.
